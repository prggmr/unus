...
class Unus_Form_Validator_Alpha extends Unus_Form_Validator_Abstract
{
	...
	const STRING_EMPTY     = '%s cannot be left blank';
	...
	public function jqueryValidate()
	{
        ...
        $validate->addElement($this->getData('element_name'), array('required' => 'true', 'pwd_check_complex' => 'true'));
	}
