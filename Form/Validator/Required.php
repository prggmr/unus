...
class Unus_Form_Validator_Required extends Unus_Form_Validator_Abstract
{
	...
	public function jqueryValidate()
	{
        ...
        $validate->addElement($this->getData('element_name'), array('required' => 'true'));
        $validate->addMessage($this->getData('element_name'), array('require' => self::INVALID));
	}
