...
class Unus_Model_Table extends Unus_Data
{
    /**
    ...
    public function __construct($tblName)
    {
        ...
        $this->setData('config', new Unus_Data());
        //$this->getData('config')->setData('add',true)->setData('delete',true)->setData('edit',true)->setData('admin', true);
    ...
    public function addField($name, $type, $options = array())
    {
        ...
        $this->setData('fields', array($name => $options), true);
    }
